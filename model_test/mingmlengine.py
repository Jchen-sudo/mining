...
def predict(dataframe):
    if mlmodel.predict(dataframe)[0] == 1:
        return 'Anomaly' + str(mlmodel.predict(dataframe))
    else:
        return 'Normal'
...
if __name__ == "__main__":
    ...
    miningFlows = NFStreamer(source="./mergedMining.pcap",
                             statistical_analysis=True).to_pandas()
    featureColumns = [21, 26, 50, 16, 66, 52, 74, 42, 23, 44, 51, 33, 48, 58, 73,
